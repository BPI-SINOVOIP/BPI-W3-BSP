...
{
    printf("Usage : \n");
    printf("\t 0) ASHARP:         get asharp attri.\n");
    printf("\t 1) ASHARP:         get asharp strength.\n");
    printf("\t 2) ASHARP:         set asharp attri auto.\n");
    printf("\t 3) ASHARP:         set asharp attri manual.\n");
    printf("\t 4) ASHARP:         set asharp attri reg value.\n");
    printf("\t 5) ASHARP:         set asharp strength max value 1.0, only on auto mode has effect.\n");
    printf("\t 6) ASHARP:         set asharp strength min value 0.0, only on auto mode has effect.\n");
    printf("\t 7) ASHARP:         set asharp strength med value 0.5, only on auto mode has effect.\n");
    printf("\t 8) ASHARP:         set asharp attri to default vaule .\n");
        ...
        case '1':
            if (CHECK_ISP_HW_V30()) {
                ...
                printf("get asharp v4 attri ret:%d strength:%f done:%d\n\n",
                       ret, sharpV4Strenght.percent, sharpV4Strenght.sync.done);
            }
            break;
        case '2':
            if (CHECK_ISP_HW_V30()) {
