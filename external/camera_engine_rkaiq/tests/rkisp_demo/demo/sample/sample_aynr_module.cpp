...
{
    printf("Usage : \n");
    printf("\t 0) AYNR:         get aynr attri.\n");
    printf("\t 1) AYNR:         get aynr strength.\n");
    printf("\t 2) AYNR:         set aynr attri auto.\n");
    printf("\t 3) AYNR:         set aynr attri manual.\n");
    printf("\t 4) AYNR:         set aynr attri reg value.\n");
    printf("\t 5) AYNR:         set aynr strength max value 1.0, only on auto mode has effect.\n");
    printf("\t 6) AYNR:         set aynr strength min value 0.0, only on auto mode has effect.\n");
    printf("\t 7) AYNR:         set aynr strength med value 0.5, only on auto mode has effect.\n");
    printf("\t 8) AYNR:         set aynr attri to default vaule .\n");
