...
{
    printf("Usage : \n");
    printf("\t 0) ABAYER2DNR:         get abayer2dnr attri.\n");
    printf("\t 1) ABAYER2DNR:         get abayer2dnr strength.\n");
    printf("\t 2) ABAYER2DNR:         set abayer2dnr attri auto.\n");
    printf("\t 3) ABAYER2DNR:         set abayer2dnr attri manual.\n");
    printf("\t 4) ABAYER2DNR:         set abayer2dnr attri reg value.\n");
    printf("\t 5) ABAYER2DNR:         set abayer2dnr strength max value 1.0 only on auto mode has effect.\n");
    printf("\t 6) ABAYER2DNR:         set abayer2dnr strength min value 0.0 only on auto mode has effect.\n");
    printf("\t 7) ABAYER2DNR:         set abayer2dnr strength med value 0.5 only on auto mode has effect.\n");
    printf("\t 8) ABAYER2DNR:         set abayer2dnr attri default vaule .\n");
    ...
    do {
        ...
        case '5':
            if (CHECK_ISP_HW_V30()) {
                ...
                printf("Set abayer2dnr v2 set streangth ret:%d strength:%f \n\n", ret, bayer2dnrV2Strenght.percent);
            }
            break;
        case '6':
            if (CHECK_ISP_HW_V30()) {
