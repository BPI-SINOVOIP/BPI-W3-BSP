...
{
    printf("Usage : \n");
    printf("\t 0) ABAYERTNR:         get abayertnr attri.\n");
    printf("\t 1) ABAYERTNR:         get abayertnr strength.\n");
    printf("\t 2) ABAYERTNR:         set abayertnr attri auto.\n");
    printf("\t 3) ABAYERTNR:         set abayertnr attri manual.\n");
    printf("\t 4) ABAYERTNR:         set abayertnr attri reg value.\n");
    printf("\t 5) ABAYERTNR:         set abayertnr strength max value 1.0, only on auto mode has effect.\n");
    printf("\t 6) ABAYERTNR:         set abayertnr strength min value 0.0, only on auto mode has effect.\n");
    printf("\t 7) ABAYERTNR:         set abayertnr strength med value 0.5, only on auto mode has effect.\n");
    printf("\t 8) ABAYERTNR:         set abayertnr attri to default vaule .\n");
