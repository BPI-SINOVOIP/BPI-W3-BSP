...
{
    printf("Usage : \n");
    printf("\t 0) ACNR:         get acnr attri.\n");
    printf("\t 1) ACNR:         get acnr strength.\n");
    printf("\t 2) ACNR:         set acnr attri auto.\n");
    printf("\t 3) ACNR:         set acnr attri manual.\n");
    printf("\t 4) ACNR:         set acnr attri reg value.\n");
    printf("\t 5) ACNR:         set acnr strength max value 1.0, only on auto mode has effect.\n");
    printf("\t 6) ACNR:         set acnr strength min value 0.0, only on auto mode has effect.\n");
    printf("\t 7) ACNR:         set acnr strength med value 0.5, only on auto mode has effect.\n");
    printf("\t 8) ACNR:         set acnr attri to default value .\n");
