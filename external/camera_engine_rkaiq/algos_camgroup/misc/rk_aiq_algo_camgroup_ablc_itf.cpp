...
create_context(RkAiqAlgoContext **context, const AlgoCtxInstanceCfg* cfg)
{
    ...
    AblcResult_t ret = AblcInit(&pAblcCtx, (CamCalibDbV2Context_t*)(cfgInt->s_calibv2));//load json paras
...
prepare(RkAiqAlgoCom* params)
{
    ...
    if(!!(params->u.prepare.conf_type & RK_AIQ_ALGO_CONFTYPE_UPDATECALIB )) {
        CalibDbV2_Ablc_t* calibv2_ablc_calib =
            (CalibDbV2_Ablc_t*)(CALIBDBV2_GET_MODULE_PTR((void*)(pCfgParam->s_calibv2), ablc_calib));
...
RkAiqAlgoDescription g_RkIspAlgoDescCamgroupAblc = {
    .common = {
